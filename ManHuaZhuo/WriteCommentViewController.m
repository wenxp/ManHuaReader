...
-(void)keyboardWillAppear:(NSNotification *)notif
{
    ...
    [commentImgView setImage:[UIImage imageNamed:@"comment_input_boxa"]];
...
- (void)viewDidLoad
{
    ...
    [commentImgView setImage:[UIImage imageNamed:@"comment_fakedinput"]];
    ...
    [btnComment setBackgroundImage:[UIImage imageNamed:@"comment_bar_btn_bg"] forState:UIControlStateNormal];
