...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   //书籍管理
    ...
    {
        [recomNavController.navigationBar setBackgroundImage:[UIImage imageNamed:@"nav_bg"] forBarMetrics:UIBarMetricsDefault];
        [cataNavController.navigationBar setBackgroundImage:[UIImage imageNamed:@"nav_bg"] forBarMetrics:UIBarMetricsDefault];
        [manageNavVController.navigationBar setBackgroundImage:[UIImage imageNamed:@"nav_bg"] forBarMetrics:UIBarMetricsDefault];
    }
    
    
    CustomTabBarView *reComTabBar=[[CustomTabBarView alloc] initWithText:@"热门推荐" Image:[UIImage imageNamed:@"tab_featured"] selectedImg:[UIImage imageNamed:@"tab_featured_seclected"]];
    CustomTabBarView *cataTabBar=[[CustomTabBarView alloc] initWithText:@"漫画分类" Image:[UIImage imageNamed:@"tab_browse"] selectedImg:[UIImage imageNamed:@"tab_browse_seclected"]];
    CustomTabBarView *manageTabBar=[[CustomTabBarView alloc] initWithText:@"我的漫画" Image:[UIImage imageNamed:@"tab_free"] selectedImg:[UIImage imageNamed:@"tab_free_seclected"]];
    ...
    [tabBarController setViewControllers:[NSArray arrayWithObjects:recomNavController,cataNavController,manageNavVController, nil]];//downNavVController,settingVController
    ...
    bottomView=[[BottomTabBarView alloc] initWithFrame:CGRectMake(0, self.window.frame.size.height-44, self.window.frame.size.width, 44) tabBarItems:[NSArray arrayWithObjects:reComTabBar,cataTabBar,manageTabBar,nil]];//downTabBar,settingTabBar
    [bottomView setDelegate:self];
    [bottomView setBackgroundImage:[UIImage imageNamed:@"tabbar_bg"]];
    ...
    self.navBarBgImg=[UIImage imageNamed:@"nav_bg_iso4"];
