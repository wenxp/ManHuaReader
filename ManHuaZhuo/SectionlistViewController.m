...
-(void)loadView
{
    ...
    [btnSelect setBackgroundImage:[UIImage imageNamed:@"product_button_blue"] forState:UIControlStateNormal];
    ...
    [btnSection setBackgroundImage:[UIImage imageNamed:@"product_button_blue"] forState:UIControlStateNormal];
    ...
    switch (btn.tag) {
        case kControlDownSection://下载章节
        {
            ...
            if(!isEditing)
            {
                ...
                [btnDown setBackgroundImage:[UIImage imageNamed:@"nav_normal"] forState:UIControlStateNormal];
