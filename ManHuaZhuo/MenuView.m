...
{
    UIImageView *titleView=[[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sidebar_cell_title"]] autorelease];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell==nil)
    {
        ...
        //右侧的箭头
        UIImageView *rightImgView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sidebar_cell_access"]];
        [cell setAccessoryView:rightImgView];
        [rightImgView release];
        
        
        //背景图和按下状态图
        UIImageView *cellBgView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sidebar_cell"]];
        [cell setBackgroundView:cellBgView];
        [cellBgView release];
        
        UIImageView *cellPressView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sidebar_cell_pressed"]];
