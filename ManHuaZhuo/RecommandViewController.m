...
-(void)loadView
{
    ...
    [btn setBackgroundImage:[UIImage imageNamed:@"nav_search"] forState:UIControlStateNormal];
    [btn setBackgroundImage:[UIImage imageNamed:@"nav_search_pressed"] forState:UIControlStateHighlighted];
