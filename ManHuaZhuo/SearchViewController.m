...
- (void)viewDidLoad
{
    ...
    [btnCondition setBackgroundImage:[UIImage imageNamed:@"nav_sort"] forState:UIControlStateNormal];
    [btnCondition setBackgroundImage:[UIImage imageNamed:@"nav_sort_press"] forState:UIControlStateHighlighted];
