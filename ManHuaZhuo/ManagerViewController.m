...
-(void)loadView
{
    ...
    [btnGroup setBackgroundImage:[UIImage imageNamed:@"nav_normal"] forState:UIControlStateNormal];
    ...
    [btn setBackgroundImage:[UIImage imageNamed:@"nav_normal"] forState:UIControlStateNormal];
...
{   
    if([groupTableView isEditing])
    {
        ...
        [btnEdit setBackgroundImage:[UIImage imageNamed:@"nav_normal"] forState:UIControlStateNormal];
